...
mod tests {
    ...
    struct DummyBlockDeviceVolumeStatusNotDirty;
    struct DummyBlockDeviceVolumeStatusDirty;
    ...
    impl BlockDevice for DummyBlockDeviceVolumeStatusNotDirty {
        type Error = Error;
    ...
    impl BlockDevice for DummyBlockDeviceVolumeStatusDirty {
        type Error = Error;
    ...
    #[test]
    fn partition0() {
        let mut c: VolumeManager<DummyBlockDeviceVolumeStatusNotDirty, Clock, 2, 2> =
            VolumeManager::new_with_limits(
                DummyBlockDeviceVolumeStatusNotDirty,
                Clock,
                0xAA00_0000,
            );
        ...
        // TODO: check that it was really set!
    }

    #[test]
    fn partition0_dirty() {
        let mut c: VolumeManager<DummyBlockDeviceVolumeStatusDirty, Clock, 2, 2> =
            VolumeManager::new_with_limits(DummyBlockDeviceVolumeStatusDirty, Clock, 0xAA00_0000);
